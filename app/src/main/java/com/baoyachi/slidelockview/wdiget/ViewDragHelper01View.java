...
public class ViewDragHelper01View extends RelativeLayout {
    ...
    public ViewDragHelper01View(Context context) {
        this(context, null);
    }

    public ViewDragHelper01View(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViewDragHelper01View(Context context, AttributeSet attrs, int defStyleAttr) {
